...
export default {
    ...
    methods: {
        ...
        getAnswer() {
            AnswerDataService.get(this.$route.params.qid)
            .then(response => {
                this.answer.atitle = response.data.atitle;
                this.answer.acontent = response.data.acontent;
                console.log(response.data);
            }).catch(e => {
                console.log(e);
            })
        ...
        saveAnswer() {    // 답변 저장
            ...
            AnswerDataService.modify(data, this.$route.params.qid)
            .then(response => {
