<template>
    <div>
        <section>
        <div class="container">
            <h1 style="float:">About</h1>
            </div>
            <hr style="width: 1350px; margin-left: 300px;">
...
<table cellpadding="30">
    <tr>
        ...
        <td>
            <div id="imgs">          
                <img :src="require(`../assets/img/${about2}.png`)" alt="이미지2" style="width: 400px">
            </div> 
        </td>
    </tr>     
    </table>
    <div id="aboutcon">
    <h1>PREMIUM BOTANIC MARKET</h1>
   <p>
        trèfle(트레플)은 클로버를 뜻하는 불어로부터 지어진 이름입니다. <br>
        방문해주시는 모든 이에게 클로버의 행운이 넘치기를 원하는 마음을 담아 <br>
        화분 하나하나 정성스레 제작해 보내드리고 있습니다.  <br><br><br>

        각각의 화분이 가진 이야기에 귀를 기울여 보시고 <br>
        가족, 친구, 나 자신에게 잊지 못할 행운을 안겨주세요. <br> 
    </p>
    </div>
    </section>
    </div>
